...
TEST(dormidontov_e_sign_sort_batcher_seq, test_50) {
...
TEST(dormidontov_e_sign_sort_batcher_seq, test_0) {
  // Create data
...
TEST(dormidontov_e_sign_sort_batcher_seq, test_1) {
...
TEST(dormidontov_e_sign_sort_batcher_seq, test_1000_shuffe) {
...
TEST(dormidontov_e_sign_sort_batcher_seq, test_wrong_size) {
  constexpr size_t kCount = 50;
