...
TEST(vragov_i_gaussian_filter_vertical_seq, IdentityOnConstantImage) {
  constexpr int kX = 5;
  constexpr int kY = 5;
...
TEST(vragov_i_gaussian_filter_vertical_seq, VerticalGradientBlur) {
  constexpr int kX = 3;
  constexpr int kY = 7;
...
TEST(vragov_i_gaussian_filter_vertical_seq, HandlesEmptyImage) {
  std::vector<int> in;
  std::vector<int> out;
  auto task_data = std::make_shared<ppc::core::TaskData>();
  task_data->inputs.emplace_back(reinterpret_cast<uint8_t*>(in.data()));
...
TEST(vragov_i_gaussian_filter_vertical_seq, InvalidDimensionsFailValidation) {
  constexpr int kX = 4;
  constexpr int kY = 5;
...
TEST(vragov_i_gaussian_filter_vertical_seq, SingleElementImage) {
  constexpr int kX = 1;
  constexpr int kY = 1;
...
TEST(vragov_i_gaussian_filter_vertical_seq, RandomImageBlurAverage) {
  constexpr int kX = 20;
  constexpr int kY = 20;
...
TEST(vragov_i_gaussian_filter_vertical_seq, NegativeDimensionsFailValidation) {
  constexpr int kX = -3;
  constexpr int kY = -5;
