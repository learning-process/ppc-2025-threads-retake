...
void RunRandomMatrixTest(int size) {
  ...
  malyshev_v_strassen_algorithm_seq::StrassenSequential strassen_task_sequential(task_data_seq);
...
void RunFixedMatrixTest(int size) {
  ...
  std::vector<double> expected_result = malyshev_v_strassen_algorithm_seq::StandardMultiply(in_a, in_b, size);
  std::vector<double> out(size * size, 0.0);
...
TEST(malyshev_v_strassen_algorithm_seq, test_matrix_63x63_fixed) { RunFixedMatrixTest(63); }

TEST(malyshev_v_strassen_algorithm_seq, test_matrix_64x64_fixed) { RunFixedMatrixTest(64); }

TEST(malyshev_v_strassen_algorithm_seq, test_random_matrix_64x64) { RunRandomMatrixTest(64); }

TEST(malyshev_v_strassen_algorithm_seq, test_random_matrix_127x127) { RunRandomMatrixTest(127); }

TEST(malyshev_v_strassen_algorithm_seq, test_random_matrix_128x128) { RunRandomMatrixTest(128); }