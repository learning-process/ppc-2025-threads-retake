#include "seq/malyshev_v_strassen_algorithm/include/ops_seq.hpp"
...
bool malyshev_v_strassen_algorithm_seq::StrassenSequential::PreProcessingImpl() {
...
bool malyshev_v_strassen_algorithm_seq::StrassenSequential::ValidationImpl() {
...
bool malyshev_v_strassen_algorithm_seq::StrassenSequential::RunImpl() {
  output_matrix_ = StrassenMultiply(input_matrix_a_, input_matrix_b_, matrix_size_);
  return true;
}

bool malyshev_v_strassen_algorithm_seq::StrassenSequential::PostProcessingImpl() {
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StrassenSequential::AddMatrices(const std::vector<double>& a,
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StrassenSequential::SubtractMatrices(
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StandardMultiply(const std::vector<double>& a,
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StrassenSequential::PadMatrixToPowerOfTwo(
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StrassenSequential::TrimMatrixToOriginalSize(
...
std::vector<double> malyshev_v_strassen_algorithm_seq::StrassenSequential::StrassenMultiply(
    const std::vector<double>& a, const std::vector<double>& b, int size) {
  if (size <= 32) {
...
void malyshev_v_strassen_algorithm_seq::StrassenSequential::SplitMatrix(const std::vector<double>& parent,
...
void malyshev_v_strassen_algorithm_seq::StrassenSequential::MergeMatrix(std::vector<double>& parent,
