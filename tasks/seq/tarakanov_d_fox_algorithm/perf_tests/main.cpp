...
TEST(tasksequential_perf_test, test_matmul_100x100) {
  test_matmul_performance(100);
}

TEST(tasksequential_perf_test, test_matmul_500x500) {
  test_matmul_performance(500);
}

TEST(tasksequential_perf_test, test_matmul_1000x1000) {
  test_matmul_performance(1000);
}