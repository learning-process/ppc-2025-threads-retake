...
TEST(somov_i_radix_sort_simple_merging_seq, FirstTest) {
  ...
  somov_i_radix_sort_simple_merging_seq::TestTaskSequential test_task(task_data);
...
TEST(somov_i_radix_sort_simple_merging_seq, SingleElementTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, NegativeAndPositiveTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, RandomVectorTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, AllSameElementsTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, ExtremeValuesTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, TinyNumbersTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, InvalidInputOutputSizeTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, ValidationEmptyTest) {
...
TEST(somov_i_radix_sort_simple_merging_seq, ReverseOrderTest) {
