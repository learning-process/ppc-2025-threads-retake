...
bool makadrai_g_histogram_linear_stretching_tbb::TestTaskTBB ::PreProcessingImpl() {
...
bool makadrai_g_histogram_linear_stretching_tbb::TestTaskTBB ::ValidationImpl() {
  return task_data->outputs_count[0] > 0 && task_data->inputs_count[0] > 0 &&
         task_data->inputs_count[0] == task_data->outputs_count[0];
}

bool makadrai_g_histogram_linear_stretching_tbb::TestTaskTBB ::RunImpl() {
...
bool makadrai_g_histogram_linear_stretching_tbb::TestTaskTBB ::PostProcessingImpl() {
