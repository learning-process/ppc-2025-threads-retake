...
TEST(somov_i_radix_sort_simple_merging_tbb, BasicSortingTest) {
  ...
  somov_i_radix_sort_simple_merging_tbb::TestTaskTbb task(task_data);
...
TEST(somov_i_radix_sort_simple_merging_tbb, SingleElementTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, NegativeAndPositiveTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, AllSameElementsTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, ExtremeValuesTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, TinyNumbersTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, InvalidInputOutputSizeTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, ValidationEmptyTest) {
...
TEST(somov_i_radix_sort_simple_merging_tbb, ReverseOrderTest) {
