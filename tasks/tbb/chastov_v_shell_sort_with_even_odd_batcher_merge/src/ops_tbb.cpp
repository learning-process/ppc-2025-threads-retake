...
bool chastov_v_shell_sort_with_even_odd_batcher_merge::TestTaskTBB::PreProcessingImpl() {
...
bool chastov_v_shell_sort_with_even_odd_batcher_merge::TestTaskTBB::ValidationImpl() {
  return task_data->inputs_count[0] > 0 && task_data->inputs_count[0] == task_data->outputs_count[0];
}

bool chastov_v_shell_sort_with_even_odd_batcher_merge::TestTaskTBB::RunImpl() {
  EnhancedShellSort(input_data_);
  return true;
}

bool chastov_v_shell_sort_with_even_odd_batcher_merge::TestTaskTBB::PostProcessingImpl() {
