...
bool tarakanov_d_fox_algorithm_tbb::TestTaskTBB::PreProcessingImpl() {
...
bool tarakanov_d_fox_algorithm_tbb::TestTaskTBB::ValidationImpl() {
  unsigned int input_size = task_data->inputs_count[0];
  if (input_size % 2 != 0) {
    return false;
  }
...
bool tarakanov_d_fox_algorithm_tbb::TestTaskTBB::RunImpl() {
...
bool tarakanov_d_fox_algorithm_tbb::TestTaskTBB::PostProcessingImpl() {
