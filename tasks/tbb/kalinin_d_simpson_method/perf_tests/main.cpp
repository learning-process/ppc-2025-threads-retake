...
TEST(kalinin_d_simpson_method_tbb, perf_pipeline_run_unit_cube_linear_sum) {
  ...
  auto task = std::make_shared<kalinin_d_simpson_method_tbb::SimpsonNDTBB>(task_data);
...
TEST(kalinin_d_simpson_method_tbb, perf_task_run_hyperrectangle_constant) {
