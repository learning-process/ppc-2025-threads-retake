...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_small_array) {
  ...
  // Create Task
  budazhapova_e_qs_merge_sort_tbb::QSMergeSortTBB test_task_tbb(task_data_tbb);
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_medium_array) {
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_large_array) {
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_already_sorted) {
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_reverse_sorted) {
  constexpr size_t kCount = 50;
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_sort_empty_array) {
  std::vector<int> in = {};
...
TEST(budazhapova_e_qs_merge_sort_tbb, test_validation_fail) {
  constexpr size_t kCount = 10;
