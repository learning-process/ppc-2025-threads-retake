...
bool vasenkov_a_vertical_gauss_3x3_tbb::VerticalGauss::ValidationImpl() {
  return task_data->inputs_count[2] == 9 &&
         (task_data->inputs_count[0] * task_data->inputs_count[1] * kCHANNELS) == task_data->outputs_count[0];
}

bool vasenkov_a_vertical_gauss_3x3_tbb::VerticalGauss::RunImpl() {
  ...
  tbb::parallel_for(tbb::blocked_range2d<int>(1, img_height_ - 1, 1, img_width_ - 1),
...
bool vasenkov_a_vertical_gauss_3x3_tbb::VerticalGauss::PostProcessingImpl() {
