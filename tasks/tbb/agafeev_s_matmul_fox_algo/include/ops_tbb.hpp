...
namespace agafeev_s_matmul_fox_algo_tbb {
...
class MultiplMatrixTBB : public ppc::core::Task {
 public:
  explicit MultiplMatrixTBB(ppc::core::TaskDataPtr task_data) : Task(std::move(task_data)) {}
