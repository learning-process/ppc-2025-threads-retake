...
TEST(makhov_m_jarvis_algorithm_tbb, test_pipeline_run) {
  // Create data
  std::vector<makhov_m_jarvis_algorithm_tbb::Point> in(3000000);
  ...
  uint8_t* buffer = makhov_m_jarvis_algorithm_tbb::TaskTBB::ConvertPointsToByteArray(in, buffer_size);
  ...
  // Create Task
  auto task_sequential = std::make_shared<makhov_m_jarvis_algorithm_tbb::TaskTBB>(task_data_seq);
...
TEST(makhov_m_jarvis_algorithm_tbb, test_task_run) {
  // Create data
  std::vector<makhov_m_jarvis_algorithm_tbb::Point> in(3000000);
