...
TEST(veliev_e_monte_carlo_tbb, test_pipeline_run) {
  double res = 8;
  ...
  auto task_seq = std::make_shared<veliev_e_monte_carlo_tbb::VelievEMonteCarloTbb>(task_data_tbb);
...
TEST(veliev_e_monte_carlo_tbb, test_task_run) {
  double res = 8;
