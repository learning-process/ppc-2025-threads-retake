...
bool veliev_e_tbb_test::VelievEMonteCarloSeq::PreProcessingImpl() {
...
bool veliev_e_tbb_test::VelievEMonteCarloSeq::ValidationImpl() {
  return task_data->inputs_count[0] == 2 && task_data->inputs_count[1] == 2 && task_data->outputs_count[0] == 1;
}

bool veliev_e_tbb_test::VelievEMonteCarloSeq::RunImpl() {
...
bool veliev_e_tbb_test::VelievEMonteCarloSeq::PostProcessingImpl() {
