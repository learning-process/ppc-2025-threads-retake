...
bool veliev_e_all_test::VelievEMonteCarloSeq::PreProcessingImpl() {
  ...
  function_ = reinterpret_cast<veliev_func_all::Func>(task_data->inputs[2]);
...
bool veliev_e_all_test::VelievEMonteCarloSeq::ValidationImpl() {
  return task_data->inputs_count[0] == 2 && task_data->inputs_count[1] == 2 && task_data->outputs_count[0] == 1;
}

bool veliev_e_all_test::VelievEMonteCarloSeq::RunImpl() {
...
bool veliev_e_all_test::VelievEMonteCarloSeq::PostProcessingImpl() {
