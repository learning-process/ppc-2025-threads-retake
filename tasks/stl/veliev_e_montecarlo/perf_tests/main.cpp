...
TEST(veliev_e_monte_carlo_stl, test_pipeline_run) {
  double res = 8;
  ...
  auto task_seq = std::make_shared<veliev_e_monte_carlo_stl::VelievEMonteCarloStl>(task_data_stl);
...
TEST(veliev_e_monte_carlo_stl, test_task_run) {
  double res = 8;
