...
TEST(leontev_n_graham_stl, test_10_points_basic) {
  ...
  task_data_stl->inputs.emplace_back(reinterpret_cast<uint8_t *>(in_x.data()));
  task_data_stl->inputs.emplace_back(reinterpret_cast<uint8_t *>(in_y.data()));
  task_data_stl->inputs_count.emplace_back(in_x.size());
  task_data_stl->outputs.emplace_back(reinterpret_cast<uint8_t *>(out_x.data()));
  task_data_stl->outputs.emplace_back(reinterpret_cast<uint8_t *>(out_y.data()));
  task_data_stl->outputs.emplace_back(reinterpret_cast<uint8_t *>(&out_size));
  task_data_stl->outputs_count.emplace_back(out_x.size());

  // Create Task
  leontev_n_graham_stl::GrahamStl test_task_stl(task_data_stl);
...
TEST(leontev_n_graham_stl, test_20_points_square) {
...
TEST(leontev_n_graham_stl, test_lot_of_points) {
  ...
  // Create Task
  leontev_n_graham_stl::GrahamSeq test_task_seq(task_data_seq);
  leontev_n_graham_stl::GrahamStl test_task_stl(task_data_stl);
