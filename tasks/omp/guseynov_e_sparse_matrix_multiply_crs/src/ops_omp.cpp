...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultOMP::PreProcessingImpl() {
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultOMP::ValidationImpl() {
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultOMP::RunImpl() {
  *B_mat_ = T(*B_mat_);
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultSequantial::PreProcessingImpl() {
  A_mat_ = reinterpret_cast<CRSMatrix*>(task_data->inputs[0]);
  B_mat_ = reinterpret_cast<CRSMatrix*>(task_data->inputs[1]);
  Result_ = reinterpret_cast<CRSMatrix*>(task_data->outputs[0]);
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultSequantial::ValidationImpl() {
  if (task_data->inputs.size() != 2 || task_data->outputs.size() != 1 || !task_data->inputs_count.empty() ||
      !task_data->outputs_count.empty()) {
    return false;
  }
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultSequantial::RunImpl() {
  *B_mat_ = T(*B_mat_);
...
bool guseynov_e_sparse_matrix_multiply_crs_omp::SparseMatMultSequantial::PostProcessingImpl() {
  auto* output = reinterpret_cast<CRSMatrix*>(task_data->outputs[0]);
