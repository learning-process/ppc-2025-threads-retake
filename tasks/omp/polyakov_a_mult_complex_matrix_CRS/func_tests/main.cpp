...
TEST(polyakov_a_mult_complex_matrix_crs_omp, test_none_valid) {
  ...
  polyakov_a_mult_complex_matrix_crs_omp::MatrixCRS a(pcrs::Rows{kN}, pcrs::Cols{kM});
  polyakov_a_mult_complex_matrix_crs_omp::MatrixCRS b(pcrs::Rows{k_}, pcrs::Cols{kT});
