...
TEST(polyakov_a_mult_complex_matrix_CRS_omp, test_mul_identity_matrix) {
  ...
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS B(n, n, values, col_ind, row_ptr);
  ...
  // Create Task
  polyakov_a_mult_complex_matrix_CRS_omp::TestTaskOMP test_task_omp(task_data_omp);
...
TEST(polyakov_a_mult_complex_matrix_CRS_omp, test_mul_negative_identity_matrix) {
  constexpr size_t n = 1000;
  ...
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS B(n, n, b_values, b_col_ind, b_row_ptr);
  ...
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS expect(n, n, exp_values, A.col_ind, A.row_ptr);
...
TEST(polyakov_a_mult_complex_matrix_CRS_omp, test_mul_none_square_matrix) {
  ...
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS C(n, k);

  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS A(n, m, a_values, a_col_ind, a_row_ptr);
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS B(m, k, b_values, b_col_ind, b_row_ptr);
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS expect(n, k, exp_values, exp_col_ind, exp_row_ptr);
...
TEST(polyakov_a_mult_complex_matrix_CRS_omp, test_none_valid) {
  constexpr size_t n = 5;
  constexpr size_t m = 4;
  constexpr size_t k = 3;
  constexpr size_t t = 10;

  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS A(n, m);
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS B(k, t);
  polyakov_a_mult_complex_matrix_CRS_omp::MatrixCRS C;
