...
TEST(anikin_m_block_gauss_omp, zero_test) {
  int x = 5;
  int y = 5;
  ...
  // Create Task
  anikin_m_block_gauss_omp::BlockGaussOMP test_task_omp(task_data_seq);
...
TEST(anikin_m_block_gauss_omp, calc_test) {
  int x = 5;
  int y = 5;
...
TEST(anikin_m_block_gauss_omp, size_validation_test0) {
  int n = 0;
  int m = 0;
...
TEST(anikin_m_block_gauss_omp, size_validation_test1) {
  int n = 0;
  int m = 0;
  std::vector<int> image(n * m, 1);
