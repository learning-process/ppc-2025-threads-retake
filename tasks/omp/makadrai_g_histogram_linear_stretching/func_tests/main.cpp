...
#ifndef _WIN32
TEST(makadrai_g_histogram_linear_stretching_omp, test_opencv_image_validation) {
  // loading template orginal img
  cv::Mat input_image =
      cv::imread(ppc::util::GetAbsolutePath("omp/makadrai_g_histogram_linear_stretching/data/cobble_orig.jpg"),
                 cv::IMREAD_GRAYSCALE);
  ASSERT_FALSE(input_image.empty());

  // loading template modified img
  cv::Mat reference_image =
      cv::imread(ppc::util::GetAbsolutePath("omp/makadrai_g_histogram_linear_stretching/data/cobble_mod.jpg"),
                 cv::IMREAD_GRAYSCALE);
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_opencv_manual_64x64) {
  // loading template orginal img
  cv::Mat input_image =
      cv::imread(ppc::util::GetAbsolutePath("omp/makadrai_g_histogram_linear_stretching/data/cobble_orig.jpg"),
                 cv::IMREAD_GRAYSCALE);
  ...
  makadrai_g_histogram_linear_stretching_omp::TestTaskSequential test_task_ompuential(task_data_omp);
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_manual_9) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_manual_10) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_manual_25) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_stretched) {
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_boundary_values) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_flat) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_full_black) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_full_white) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_single_non_flat_pixel) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_single_non_flat_pixel_2) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_10k_generated) {
  // Create data
  const int sz = 10000;
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_empty) {
  // Create data
...
TEST(makadrai_g_histogram_linear_stretching_omp, test_in_out_NE) {
  // Create data
