...
bool makadrai_g_histogram_linear_stretching_omp::TestTaskSequential::PreProcessingImpl() {
...
bool makadrai_g_histogram_linear_stretching_omp::TestTaskSequential::ValidationImpl() {
  return task_data->outputs_count[0] > 0 && task_data->inputs_count[0] > 0 &&
         task_data->inputs_count[0] == task_data->outputs_count[0];
}

bool makadrai_g_histogram_linear_stretching_omp::TestTaskSequential::RunImpl() {
...
bool makadrai_g_histogram_linear_stretching_omp::TestTaskSequential::PostProcessingImpl() {
