...
TEST(veliev_e_monte_carlo_omp, test_pipeline_run) {
  double res = 8;
  ...
  auto task_seq = std::make_shared<veliev_e_monte_carlo_omp::VelievEMonteCarloOmp>(task_data_omp);
...
TEST(veliev_e_monte_carlo_omp, test_task_run) {
  double res = 8;
