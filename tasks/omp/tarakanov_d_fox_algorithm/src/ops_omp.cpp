...
bool tarakanov_d_fox_algorithm_omp::TestTaskOpenMP::PreProcessingImpl() {
...
bool tarakanov_d_fox_algorithm_omp::TestTaskOpenMP::ValidationImpl() {
  unsigned int input_size = task_data->inputs_count[0];
  if (input_size % 2 != 0) {
    return false;
  }
...
bool tarakanov_d_fox_algorithm_omp::TestTaskOpenMP::RunImpl() {
...
bool tarakanov_d_fox_algorithm_omp::TestTaskOpenMP::PostProcessingImpl() {
