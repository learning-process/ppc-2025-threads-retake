...
TEST(malyshev_v_strassen_algorithm_omp, test_pipeline_run) {
  ...
  std::vector<double> expected = malyshev_v_strassen_algorithm_omp::StandardMultiply(in_a, in_b, kMatrixSize);
  ...
  auto test_task = std::make_shared<malyshev_v_strassen_algorithm_omp::StrassenOmp>(task_data);
