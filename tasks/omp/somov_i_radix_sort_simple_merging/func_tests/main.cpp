...
TEST(somov_i_radix_sort_simple_merging_omp, FirstTest) {
  ...
  somov_i_radix_sort_simple_merging_omp::TestTaskOMP test_task(task_data);
...
TEST(somov_i_radix_sort_simple_merging_omp, SingleElementTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, NegativeAndPositiveTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, AllSameElementsTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, ExtremeValuesTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, TinyNumbersTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, ReverseOrderTest) {
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_NullInput) {
  ...
  somov_i_radix_sort_simple_merging_omp::TestTaskOMP task(task_data);
  ASSERT_FALSE(task.Validation());
}

TEST(somov_i_radix_sort_simple_merging_omp, Validation_NullOutput) {
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_SizeMismatch) {
  std::vector<double> input(100);
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_ZeroSize) {
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_SizeOverflow) {
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_EmptyCounts) {
  std::vector<double> input(100);
  std::vector<double> output(100);
  auto task_data = std::make_shared<ppc::core::TaskData>();
  task_data->inputs.emplace_back(reinterpret_cast<uint8_t*>(input.data()));
...
TEST(somov_i_radix_sort_simple_merging_omp, Validation_MaxSize) {
