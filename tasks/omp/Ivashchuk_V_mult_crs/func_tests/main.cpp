...
TEST(Ivashchuk_V_mult_crs, test_sparse_matmul_5x5) {
  ...
  // Create Task
  Ivashchuk_V_mult_crs::SparseMatrixComplexCRS test_task_tbb(task_data_tbb);
...
TEST(Ivashchuk_V_mult_crs, test_sparse_matmul_10x10_from_file) {
  std::string line;
