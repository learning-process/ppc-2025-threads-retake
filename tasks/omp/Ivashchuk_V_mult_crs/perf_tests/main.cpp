...
TEST(Ivashchuk_V_mult_crs, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_tbb = std::make_shared<Ivashchuk_V_mult_crs::SparseMatrixComplexCRS>(task_data_tbb);
...
TEST(Ivashchuk_V_mult_crs, test_task_run) {
  constexpr int kCount = 100;
