...
TEST(chernova_n_cannon_matrix_mul_omp, test_pipeline_run) {
  ...
  std::vector<double> res = chernova_n_cannon_matrix_mul_omp::MultiplyMatrixOMP(in_mtrx_a, in_mtrx_b, n);

  auto test_task_omp = std::make_shared<chernova_n_cannon_matrix_mul_omp::TestTaskOpenMP>(task_data_omp);
